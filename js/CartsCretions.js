import { agregarProyecto } from "./Funcion_CartsCreations.js";
...
agregarProyecto(
    'proyecto 3: Mi Primer Proyecto en TypeScript',
    'Este proyecto fue desarrollado con el objetivo primordial de aprender profundamente sobre TypeScript y dar mis primeros pasos sólidos en el riguroso pero poderoso mundo de los lenguajes fuertemente tipados.',
    'img/proyecto5.png',
    'https://github.com/MoggerSir/Mi-Primer-Proyecto-en-TypeScript?tab=readme-ov-file'
);
agregarProyecto(
...
agregarProyecto(
    "Proyecto 5: Carreras Clandestinas de Gokus", 
